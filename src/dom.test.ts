...
describe('createElement', () => {
  ...
  test('with nested elements', () => {
    const element = createElement('div', { id: 'head' }, createElement('h1', 'Title'), createElement('p', 'Content'));
    expect(element.outerHTML).toBe('<div id="head"><h1>Title</h1><p>Content</p></div>');
  })
});
